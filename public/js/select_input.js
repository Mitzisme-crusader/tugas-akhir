$(document).ready(function () {
    ...
    $("#label_extra_service_common").click(function(){
        if($('#select_id_container option:selected').val() == 1){
            ...
            input_harga_20_feet.style.marginBottom = "5px";
            ...
            input_harga_20_feet.style.marginBottom = "15px";
            ...
            input_harga_40_feet.style.marginBottom = "5px";
            ...
            input_harga_40_feet.style.marginBottom = "15px";
        ...
        if($('#select_id_container option:selected').val() == 2){
            ...
            input_harga_45_feet.style.marginBottom = "5px";
            ...
            input_harga_45_feet.style.marginBottom = "15px";
